...
import javax.swing.*;
import java.util.*;
//saving the graph is done using serialization
public class A5 extends JPanel implements Serializable
{
	...
	public static void main(String[] args)
	{
        ...
        draw.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        option.setBounds(0,0,1200,100);
        draw.setBounds(10,100,1160,600);
		panel.add(draw,0,0);
		panel.add(option,1,0);
		...
		save.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try
		        {
		            ...
		            file.close();
		            JPanel p = new JPanel();
	    			JOptionPane.showMessageDialog(p,"Graph has been saved! When opening the program next time, just press on the load button.");
		        }
		...
		load.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try
		        {
		            ...
		            file.close();
		            JPanel p = new JPanel();
		            JOptionPane.showMessageDialog(p,"Graph has been loaded!");
		            c = Color.BLACK;
		            draw.repaint();
		        }
		        catch(Exception ex)
	...
	//similar to A3
	private void drawArrowLine(Graphics g, int x1, int y1, int xx, int yy, int d, int h) {
	    int dx = xx - x1, dy = yy - y1;
	    ...
	    yn = xn*sin + yn*cos + y1;
	    xn = x;
	    int[] xpoints = {xx, (int) xm, (int) xn};
	    int[] ypoints = {yy, (int) ym, (int) yn};
